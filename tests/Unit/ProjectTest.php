...
test('Project can be created with valid home-relative path', function () {
...
test('Project throws exception for invalid path', function () {
    expect(fn() => new Project(path: 'invalid/path', name: 'my-project'))
        ->toThrow(InvalidArgumentException::class);
});

test('Project name is inferred from path if not provided', function () {
